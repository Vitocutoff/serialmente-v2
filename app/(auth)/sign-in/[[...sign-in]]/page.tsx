      ...
      appearance={{
        ...
        elements: {
          ...
          socialButtonsBlockButton:
            "h-11 rounded-xl border border-white/10 bg-white text-[14px] font-medium text-black shadow-none hover:bg-white/90",
          ...
          formButtonPrimary:
            "mt-1 h-11 rounded-xl border-0 bg-gradient-to-r from-violet-500 to-fuchsia-500 text-[14px] font-semibold text-white shadow-[0_10px_30px_rgba(139,92,246,0.35)] hover:opacity-95",
